            ...
            <div className="row">
              <div className="col-md-4 animate-box">
                <div className="feature-left">
                  ...
                  <div className="feature-copy">
                    ...
                    <Link href="/Perenne_chino"><p><a href="#">Learn More <i className="icon-arrow-right22" /></a></p></Link>
                    <h3>Perenne Chino</h3>
                  </div>
                </div>
              </div>
              <div className="col-md-4 animate-box">
                <div className="feature-left">
                  ...
                  <div className="feature-copy">
                    <p>Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit.</p>
                    <Link href="/Cactus_blanco"><p><a href="#">Learn More <i className="icon-arrow-right22" /></a></p></Link>
                    <h3>Cactus Blanco</h3>
                  </div>
                </div>
              </div>
              <div className="col-md-4 animate-box">
                <div className="feature-left">
                  ...
                  <div className="feature-copy">
                    <p>Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit.</p>
                    <Link href="/P_cinta"><p><a href="#">Learn More <i className="icon-arrow-right22" /></a></p></Link>
                    <h3>Planta Cinta</h3>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-md-4 animate-box">
                <div className="feature-left">
                  ...
                  <div className="feature-copy">
                    <p>Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit.</p>
                    <Link href="/Bambu"><p><a href="#">Learn More <i className="icon-arrow-right22" /></a></p></Link>
                    <h3>Bambú</h3>
                  </div>
                </div>
              </div>
              <div className="col-md-4 animate-box">
                <div className="feature-left">
                  ...
                  <div className="feature-copy">
                    <p>Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit.</p>
                    <Link href="/Peperomia"><p><a href="#">Learn More <i className="icon-arrow-right22" /></a></p></Link>
              ...
              <div className="col-md-4 animate-box">
                <div className="feature-left">
                  ...
                  <div className="feature-copy">
                    <p>Facilis ipsum reprehenderit nemo molestias. Aut cum mollitia reprehenderit.</p>
                    <Link href="/Hoja_rota"><p><a href="#">Learn More <i className="icon-arrow-right22" /></a></p></Link>
                    <h3>Hoja Rota</h3>
                  </div>
                </div>
              </div>
