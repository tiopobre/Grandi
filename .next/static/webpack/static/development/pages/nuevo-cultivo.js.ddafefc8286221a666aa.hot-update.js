    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function agregarCultivo$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            firebase.storage.ref('test_imagenes').child(imagen.name).put(imagen).then(onFulfilled, function () {
...
//# sourceMappingURL=nuevo-cultivo.js.ddafefc8286221a666aa.hot-update.js.map