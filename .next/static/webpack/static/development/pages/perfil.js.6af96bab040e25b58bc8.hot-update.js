  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (usuario) {
      ...
      var obtenerCultivos = function obtenerCultivos() {
        firebase.db.collection('cultivos').where('creador .id', '==', usuario.uid).onSnapshot(manejarSnapShot); //firebase.db.collection('plantas').where("Medicinal", '==', true).onSnapshot(manejarSnapShot);
      };
...
//# sourceMappingURL=perfil.js.6af96bab040e25b58bc8.hot-update.js.map