...
var nuevoCultivo = function nuevoCultivo() {
  ...
  var handleURL = function handleURL() {
    ...
    firebase.storage.ref("test_imagenes").child(uniqid()).getDownloadURL().then(function (url) {
      console.log("url", url);
      setUrlImagen(url);
    });
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function agregarCultivo$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            handleURL();
            console.log("Usuario", usuario.uid); // Crear cultivo
            ...
            firebase.db.collection('cultivos').add(cultivo); //return Router.push('/perfil');
...
//# sourceMappingURL=nuevo-cultivo.js.10fd56e94363bb90be3b.hot-update.js.map