      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            firebase.storage.ref('test_imagenes').child(imagen.name).put(imagen).on(storage.ref("test_imagenes").child(imagen.name).getDownloadURL().then(function (url) {
              console.log(url);
              setUrlImagen(url);
            }));
...
//# sourceMappingURL=Nuevo-cultivo.js.d0a065446bc3908ed6b3.hot-update.js.map