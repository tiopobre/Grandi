...
/* harmony import */ var react_firebase_file_uploader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-firebase-file-uploader */ "./node_modules/react-firebase-file-uploader/lib/index.js");
/* harmony import */ var react_firebase_file_uploader__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(react_firebase_file_uploader__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _hooks_useValidacion__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../hooks/useValidacion */ "./hooks/useValidacion.jsx");
/* harmony import */ var _validacion_validarNuevoCultivo__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../validacion/validarNuevoCultivo */ "./validacion/validarNuevoCultivo.jsx");
...
var nuevoCultivo = function nuevoCultivo() {
  ...
  var _usestate = usestate(''),
      ...
      urliImagen = _usestate2[0],
      setUrlImagen = _usestate2[1];

  var _useValidacion = Object(_hooks_useValidacion__WEBPACK_IMPORTED_MODULE_7__["default"])(STATE_INICIAL, _validacion_validarNuevoCultivo__WEBPACK_IMPORTED_MODULE_8__["default"], agregarCultivo),
  ...
  handleUploadStart = function handleUploadStart() {
    setProgreso(0);
    setSubinedo(true);
  };

  handleProgress = function handleProgress(progress) {
    return _this.setState({
      progreso: progreso
    });
  };

  handleUploadError = function handleUploadError(error) {
    {
      setSubinedo(error);
      console.error(error);
    }
  ...
  handleUploadSuccess = function handleUploadSuccess(filename) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            firebase.storage().ref("images").child(nombre).getDownloadURL().then(function (url) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", next_router__WEBPACK_IMPORTED_MODULE_4___default.a.push('/login'));
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx(_components_Layaout_layaout__WEBPACK_IMPORTED_MODULE_3__["default"], {
  ...
  }, "Descripcion Cultivo"), __jsx(react_firebase_file_uploader__WEBPACK_IMPORTED_MODULE_6___default.a, {
    accept: "image*/*",
    name: "imagen",
    value: imagen,
    onChange: handleChange,
    ...
    onUploadStart: _this.handleUploadStart,
    onUploadError: _this.handleUploadError,
    onUploadSuccess: _this.handleUploadSuccess,
...
//# sourceMappingURL=Nuevo-cultivo.js.144ff14017503f09a4a8.hot-update.js.map