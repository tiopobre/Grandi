  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (usuario) {
      ...
      var obtenerCultivos = function obtenerCultivos() {
        firebase.db.collection('cultivos').where('votos', '==', 0).onSnapshot(manejarSnapShot); //firebase.db.collection('plantas').where("Medicinal", '==', true).onSnapshot(manejarSnapShot);
      };
...
//# sourceMappingURL=perfil.js.1f59fb52eaf1cf869f3c.hot-update.js.map