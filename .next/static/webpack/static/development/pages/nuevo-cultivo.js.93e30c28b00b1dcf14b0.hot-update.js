...
var nuevoCultivo = function nuevoCultivo() {
  ...
  var Enviar_Firebase = function Enviar_Firebase() {
    ...
    firebase.storage.ref("test_imagenes").child(imagen.name).getDownloadURL().then(function (url) {
      ...
      firebase.db.collection('cultivos').add(cultivo).then(function () {
        console.log("se subió cultivo");
        return next_router__WEBPACK_IMPORTED_MODULE_3___default.a.push('/perfil');
      });
    });
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function agregarCultivo$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            firebase.storage.ref('test_imagenes').child(imagen.name).put(imagen).then(function () {
...
//# sourceMappingURL=nuevo-cultivo.js.93e30c28b00b1dcf14b0.hot-update.js.map