...
var nuevoCultivo = function nuevoCultivo() {
  ...
  var handleURL = function handleURL() {
    ...
    firebase.storage.ref("test_imagenes").child(uniqid()).put(imagen).getDownloadURL().then(function (url) {
      console.log("url", url);
      setUrlImagen(url);
    });
...
//# sourceMappingURL=nuevo-cultivo.js.e11666db4d3db7cb6ef6.hot-update.js.map