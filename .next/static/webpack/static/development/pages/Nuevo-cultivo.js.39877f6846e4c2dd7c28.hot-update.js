...
var nuevoCultivo = function nuevoCultivo() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log("Antes de Firebease storage");
            firebase.storage.ref().child("test_imagenes").getDownloadURL().then(function (url) {
              console.log(url);
              setUrlImagen(url);
            });
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(_components_Layaout_layaout__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    storageRef: firebase.storage.ref("test_imagenes"),
...
//# sourceMappingURL=Nuevo-cultivo.js.39877f6846e4c2dd7c28.hot-update.js.map